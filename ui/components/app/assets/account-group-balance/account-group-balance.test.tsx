...
} from '../../../../selectors/assets-unify-state';
...
jest.mock('../../../../selectors/assets-unify-state', () => ({
  ...
  selectAggregatedBalanceForSelectedAccount: jest.fn(),
}));
...
describe('AccountGroupBalance', () => {
  ...
  describe('assets unify state', () => {
    ...
    it('displays aggregated fiat total when feature flag is enabled and aggregated balance has totalBalanceInFiat', () => {
      ...
      jest.mocked(selectAggregatedBalanceForSelectedAccount).mockReturnValue({
        entries: [],
    ...
    it('displays selected group balance when feature flag is enabled but aggregated balance is null', () => {
      arrange(createMockBalance());
      jest.mocked(getIsAssetsUnifyStateEnabled).mockReturnValue(true);
      jest
        .mocked(selectAggregatedBalanceForSelectedAccount)
