...
export async function fetchHistoricalUiStartupData(
  ...
  if (currentData && Object.keys(currentData).length > 0) {
    ...
    return aggregateHistoricalData(currentData, n);
  }
  ...
  for (const branch of releaseBranches) {
    ...
    if (data && Object.keys(data).length > 0) {
      ...
      return aggregateHistoricalData(data, n);
    }
  }
...
function collectMetrics(
  ...
  result: Partial<BenchmarkEntryResult>,
 ...
 * @param n - Number of recent commits to aggregate.
